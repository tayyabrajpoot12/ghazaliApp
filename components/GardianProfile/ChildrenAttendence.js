...
export default function Children({navigation: {goBack}}) {
  ...
  return (
    <Container style={{backgroundColor: colors.background}}>
      ...
      <ScrollView
        ...
        <ChildDetial style={{color: colors.text}}>Check Attendence</ChildDetial>
        <Main>
          {ChildrenDetial.map((item, i) => {
            return (
              <Card
                ...
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate('AttendencePage', {data: item});
                  }}>
                  <Card.Content>
                    <View>
